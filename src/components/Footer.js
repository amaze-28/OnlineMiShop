  ...
  return (
    <div>
        <div className='Prefooter1'>
            <div>{repeatIcon} <p> <b>Hassle-free replacement</b> 
            <br /> 10-day easy replacement policy on mi.com </p> </div>

            <div>{shieldIcon} <p> <b>100% secure payments</b> 
            <br /> We support Cards, Wallets, EMI, COD </p> </div>
            
            <div>{mapIcon} <p> <b>Vast service network</b> 
            <br /> 1000 Mi service-centers across 600 cities </p> </div>
        </div>
        ...
        <div className='Prefooter2'>
            ...
            <div>
                <div className='ipbutton'>
                    <input type="email" text="email" placeholder='Enter Email Address'/>
                    <button>›</button>
                </div>
        ...
        <div className='Footer'>
            ...
            <div>
                <div>
                    Chat with our Virtual AI Bot(24/7 Live Agent)
                </div>
